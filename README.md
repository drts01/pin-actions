...
--full-version / --no-full-version   When used with --update, record the full resolved tag version in the
                                      comment instead of truncating to match the original precision
                                      (default: False)
--cache, --no-cache                  Enable/disable persistent disk caching (default: enabled)
--cache-dir DIR                      Directory for persistent disk cache (default: ~/.cache/pin-actions)
